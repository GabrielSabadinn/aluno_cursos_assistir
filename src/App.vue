    ...
    <div class="backTrans" :style="{ display: mostrarLogin ? 'flex' : 'none' }">
      <div class="painel" style="max-width: 445px">
        <div style="display: flex; justify-content: flex-end">
          <img src="../src/assets/X.svg" style="cursor: pointer" @click="tirarLogin" />
        </div>
        <div class="opcoes">
          <p
        ...
        <div v-if="entrar == 1" class="modalOp">
          <div>
            <input type="text" placeholder="E-mail ou CPF" v-model="usuario.email" />
            ...
            <button
              ...
              "
            >
              Entrar <img v-if="loading" width="40" src="./assets/spinner.svg" />
            </button>
        ...
        <div v-else-if="entrar == 2" class="modalOp">
          <div>
            ...
            <span>{{ txtErro.email }}</span>
            <input type="text" placeholder="CPF" v-model="usuarioCadastro.cpf" />
            <span>{{ txtErro.cpf }}</span>
            <input type="password" placeholder="Senha" v-model="usuarioCadastro.senha" />
            <span>{{ txtErro.senha }}</span>
            <input
              type="password"
              placeholder="Reptir senha"
